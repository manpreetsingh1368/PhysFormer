...
app = FastAPI(title="PhysFormer API")

@app.get("/")
def home():
    return {"message": "PhysFormer API running!"}
...
async def generate(prompt: str = Form(...)):
    ...
    save_path = "physformer_output.png"
    save_patch_image(image, save_path)
    return FileResponse(save_path, media_type="image/png", filename="physformer_output.png")
